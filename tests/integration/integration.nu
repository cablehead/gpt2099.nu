def collect-tests [] {
...

  {
    ...
    "call.cerebras.basics": {||
      gpt init
      sleep 50ms

      cat .env/cerebras | gpt provider enable cerebras
      gpt provider set-ptr milli cerebras llama-4-maverick-17b-128e-instruct
      sleep 50ms
